    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section className="space-y-6 lg:py-32 pt-6 md:pt-10 pb-8 md:pb-12">
          <div className="flex flex-col items-center gap-4 max-w-[64rem] text-center container">
        ...
        <section className="space-y-6 py-8 md:py-12 lg:py-24 container">
          ...
          <div className="justify-center gap-4 grid sm:grid-cols-2 md:grid-cols-3 mx-auto md:max-w-[64rem]">
            <Card>
              <CardHeader>
