                    ...
                    <div className="mx-auto container">
                        <div className="flex flex-col items-center gap-4 mx-auto max-w-[64rem] text-center">
                            ...
                            <p className="max-w-[42rem] text-muted-foreground sm:text-xl leading-normal sm:leading-8">
                                A interface for the Anthropic Batch API. Process
                                thousands of prompts efficiently with real-time
                                status tracking.
                            </p>
                    ...
                    <div className="mx-auto container">
                        <div className="flex flex-col items-center space-y-4 mx-auto max-w-[58rem] text-center">
                            ...
                            <p className="max-w-[85%] text-muted-foreground sm:text-lg leading-normal sm:leading-7">
                                Everything you need to manage and process large
                                batches of AI completions
                            </p>
                        </div>
                        <div className="justify-center gap-4 grid sm:grid-cols-2 md:grid-cols-3 mx-auto mt-12 md:max-w-[64rem]">
                            <Card>
                                ...
                                <CardContent>
                                    <CardDescription>
                                        Create batches with dynamic message
                                        inputs and customizable model
                                        parameters.
                                    </CardDescription>
                                </CardContent>
                            </Card>
                            <Card>
                                ...
                                <CardContent>
                                    <CardDescription>
                                        Monitor batch processing status in
                                        real-time with detailed progress
                                        information.
                                    </CardDescription>
                                </CardContent>
                            </Card>
                            <Card>
                                ...
                                <CardContent>
                                    <CardDescription>
                                        Browse your batch history with advanced
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <CardDescription>
                                        Manage your Anthropic API keys securely
                ...
                <div className="mx-auto container">
                    <div className="flex md:flex-row flex-col justify-between items-center gap-4 md:h-24">
                        <p className="text-muted-foreground text-sm md:text-left text-center leading-loose">
                            &copy; {new Date().getFullYear()} Claude Batch. All
                            rights reserved.
                        </p>
                    </div>
                </div>
