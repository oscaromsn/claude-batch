...
const apiFormSchema = z.object({
    anthropicApiKey: z
        ...
        .refine((value) => value.startsWith("sk-ant-"), {
            message:
                "Must be a valid Anthropic API key starting with 'sk-ant-'",
        }),
    anthropicWebhookSecret: z
        ...
        .refine((value) => value.startsWith("sk-ant-admin"), {
            message:
                "Must be a valid Anthropic Webhook Secret starting with 'sk-ant-admin'",
        }),
});
        ...
        const fetchCredentials = async () => {
            try {
                ...
                if (response.data.anthropicWebhookSecret) {
                    form.setValue(
                        "anthropicWebhookSecret",
                        response.data.anthropicWebhookSecret,
                    );
                }
            } catch (error) {
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Your Anthropic Webhook Secret for
