...
import { getCompletions, CompletionSortField } from "@/lib/api/completions";
  ...
  try {
    ...
    const completions = await getCompletions(
      validatedQuery.batchId,
      {
        ...
        limit: validatedQuery.limit ? parseInt(validatedQuery.limit, 10) : 100,
